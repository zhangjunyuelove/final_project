...
model_path  = "E:/cifar-10/cifar10-CNN-master/cifar10_train_2fl/model.ckpt-150000" #设置model的路径，因新版tensorflow会生成三个文件，只需写到数字前
...
def main():
    ...
    input_node = tf.placeholder(tf.float32, shape=(24, 24, 3)) #这个是你送入网络的图片大小，如果你是其他的大小自行修改
