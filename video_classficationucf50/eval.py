...
if __name__ == '__main__':
  flags.DEFINE_string("train_dir", "E:/ucf50_train/yt8m2/v2/models/frame/sample_model",
                      "The directory to load the model files from.")
  flags.DEFINE_string("output_file", "111.csv",
                      "The file to save the predictions to.")
  flags.DEFINE_string(
      "input_data_pattern", "E:/ucf50_train/25grouptf/feature_outputg*.tfrecord",
...
def inference(reader, train_dir, data_pattern, out_file_location, batch_size, top_k):
  with tf.Session() as sess, gfile.Open(out_file_location, "w+") as out_file:
    video_id_batch, video_batch, unused_labels, num_frames_batch = get_input_data_tensors(reader, data_pattern, batch_size)
