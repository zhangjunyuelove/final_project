...
flags.DEFINE_integer("iterations", 6,
...
flags.DEFINE_integer("dbof_cluster_size", 4196,
...
class NetVLAGD():
    ...
    def forward(self,reshaped_input):
        ...
        vlagd = tf.reshape(vlagd,[-1,cluster_size*feature_size])
        vlagd = tf.nn.l2_normalize(vlagd,1)
