...
if __name__ == '__main__':
  flags.DEFINE_string("train_dir", "E:/Moe_Junyue/new_model",
                      "The directory to load the model files from.")
  flags.DEFINE_string("output_file", "predictions_try.csv",
                      "The file to save the predictions to.")
  flags.DEFINE_string(
      "input_data_pattern", "E:/UCF101_TRAIN/ucf_test.tfrecord",
