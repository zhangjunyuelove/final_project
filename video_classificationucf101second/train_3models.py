...
if __name__ == "__main__":
  ...
  flags.DEFINE_string("model_feature_path", "E:/Moe_Junyue/dataset/3combined.tfrecords", "second_train_input.")
  ...
  flags.DEFINE_integer("num_epochs", 35,
...
def build_graph(reader,
  ...
  model3_input=tf.nn.l2_normalize(model3_input, feature_dim)
  ...
  with tf.name_scope("model"):
    ...
    tf.add_to_collection("input_batch3", model3_input)
