...
if __name__ == "__main__":
  ...
  flags.DEFINE_string("model_feature_path", "E:/Moe_Junyue/dataset/3combined_train.tfrecords", "second_train_input.")
        ...
        while (not sv.should_stop()) and (not self.max_steps_reached):
          ...
          if self.is_master:
            ...
            if self.is_master and time_to_export:
              saver.save(sess, "E:/Moe_Junyue/moe_model/three_models/model.ckpt", global_step_val)
